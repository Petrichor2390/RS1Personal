...
private:
    ...
    std::vector<geometry_msgs::msg::Point> generateCirclePoints(geometry_msgs::msg::Point center, double radius, int num_points) {
        ...
        for (int i = 0; i < num_points; ++i) {
            ...
            point.z = center.z; // keep the z coordinate the same as the center
    ...
    void findCylinder(){
        ...
        int numPointsInCircles = 36*9; //testing may change
        ...
        for(size_t i = 0; i < segments_.size(); i++){
            ...
            if(maxMatch > cylinderAcceptMatchesTolerance){ //cylinder found clause
        ...
        //print out the cylinders - hopefully only 1!
        if(!cylinderFound_){
...
private:
    nav_msgs::msg::OccupancyGrid occupancyGrid_;
